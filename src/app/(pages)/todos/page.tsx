...
const Todos = () => {
  return (
    <div>
      ...
      <hr />
      <div>
        <h1 className="text-2xl font-semibold mt-4">Todos</h1>
        {todosArray.map((item) => (
          <div className="mt-4 mb-12" id={item.id} key={item.id}>
            ...
            {(item.id === "get-all-todos" ||
              item.id === "get-a-single-todo" ||
              item.id === "limit-skip-todos" ||
              item.id === "search-todos") && (
